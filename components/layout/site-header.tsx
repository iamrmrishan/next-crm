...
export function SiteHeader({
  ...
  const handleSignOut = async () => {
    try {
      ...
      // Sign out on the client side first - this will trigger the auth state change
      ...
      // Also call the server logout endpoint to clear server-side session
          ...
          <div className="flex flex-1 items-center justify-end space-x-4">
            <nav className="flex items-center space-x-2">
              ...
              {loading ? (
                ...
                <Button className="mr-5" onClick={() => setAuthModalOpen(true)} size="lg">
                  Sign In
                </Button>
              )}
            </nav>
